...
*******************************************************************************/
namespace royfee\feepdf\fpdf;

define('FPDF_VERSION','1.84');

class FPDF extends FPDFBase{
	protected $Big5_widths = array(' '=>250,'!'=>250,'"'=>408,'#'=>668,'$'=>490,'%'=>875,'&'=>698,
		'\''=>250,'('=>240,')'=>240,'*'=>417,'+'=>667,','=>250,'-'=>313,'.'=>250,'/'=>520,'0'=>500,'1'=>500,
	...
	protected $GB_widths = array(' '=>207,'!'=>270,'"'=>342,'#'=>467,'$'=>462,'%'=>797,'&'=>710,'\''=>239,
	...
	function AddBig5Font($family='Big5', $name='MSungStd-Light-Acro')
	{
		...
		$this->AddCIDFonts($family,$name,$this->Big5_widths,$CMap,$registry);
	}
	...
	function AddGBFont($family='GB', $name='STSongStd-Light-Acro')
	{
		...
		$this->AddCIDFonts($family,$name,$this->GB_widths,$CMap,$registry);
	}
